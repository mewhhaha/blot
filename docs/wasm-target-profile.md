...
current Node LTS and Current release lines. Core Wasm ABI 3 remains memory32.
...
| memory64                      | deferred                                                              | ABI 3 is memory32 and current programs gain no offset-space benefit                 |
| multiple memories             | deferred                                                              | no measured benefit yet; complicates canonical adapters and interpreter portability |
| exception handling / JSPI     | not required for portable suspension                                         | Rust emits portable frames for marked suspending operations                     |
