...
the authoritative binary parser plan, and `generate:compiler-schema` translates
its lexer and island tables into checked-in typed Rust slices. The shipped
compiler executes those tables directly: it does not parse JSON, load Baba at
runtime, or implement a second grammar.
...
[`generated/compiler/compiler.wasm`](../generated/compiler/compiler.wasm) and
[`generated/compiler/prelude.snapshot`](../generated/compiler/prelude.snapshot).
