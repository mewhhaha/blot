...
includes the direct definitions commonly used to demonstrate functional
languages—persistent quicksort, naïve Fibonacci, recursive algebraic data,
recursive descent, and folds. Blot should make those definitions viable instead
of requiring a second, compiler-shaped program. A pathological example first
locks down semantics and compilation; any performance claim needs a matching
benchmark and must preserve that same source definition.
