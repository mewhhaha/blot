export {
  ...
  type CompilerEvalTelemetry,
  type CompilerExplanation,
  type CompilerHost,
  type CompilerHostPhaseCall,
  type CompilerHostPhaseSpan,
  type CompilerHostPhaseTelemetry,
  type CompilerOptions,
  type CompilerPhaseTelemetry,
  type CompilerRustPhase,
  type CompilerRustSubSpan,
  type CompilerStructuralTelemetry,
