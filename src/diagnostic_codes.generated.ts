...
export const diagnosticCodes = [
  ...
  "BLOT_LINT_",
  "BLOT_LINT_ACCUMULATOR_FOLD",
  "BLOT_LINT_ARRAY_FIND",
  "BLOT_LINT_BOOLEAN_IDENTITY_CONDITIONAL",
  "BLOT_LINT_COMPLEMENTARY_FILTERS",
  "BLOT_LINT_DISCARDED_BOOLEAN_CASE",
  "BLOT_LINT_EMPTY_ARRAY_APPEND",
  "BLOT_LINT_EMPTY_ARRAY_SPELLING",
  "BLOT_LINT_EQUALITY_CASE",
  "BLOT_LINT_FIELD_SHORTHAND",
  "BLOT_LINT_FILTERING_LOOP_PATTERN",
  "BLOT_LINT_FORWARDING_CALLBACK",
  "BLOT_LINT_GUARD_SHAPED_CASE",
  "BLOT_LINT_HANDLER_PIPELINE",
  "BLOT_LINT_IDENTICAL_CONDITIONAL_BRANCHES",
  "BLOT_LINT_IDENTITY_HANDLER_RETURN",
  "BLOT_LINT_IDENTITY_VARIANT_CASE",
  "BLOT_LINT_IF_CHAIN",
  "BLOT_LINT_ITERATOR_LOOP",
  "BLOT_LINT_LARGE_POSITIONAL_TUPLE",
  "BLOT_LINT_LOCAL_OPEN",
  "BLOT_LINT_NESTED_CASE_CHAIN",
  "BLOT_LINT_NESTED_IF_CHAIN",
  "BLOT_LINT_NOOP_REBINDING",
  "BLOT_LINT_NO_SUCH_RULE",
  "BLOT_LINT_OPEN_SHADOW",
  "BLOT_LINT_OPERATOR_SPELLING",
  "BLOT_LINT_PARAMETER_DESTRUCTURING",
  "BLOT_LINT_PERSISTENT_ARRAY_COPY",
  "BLOT_LINT_PROJECTION_DESTRUCTURING",
  "BLOT_LINT_PROVED_ARRAY_LOOKUP",
  "BLOT_LINT_PUBLIC_PRIMITIVE",
  ...
  "BLOT_LINT_VARIANT_CHAINING",
  "BLOT_LINT_VARIANT_FALLBACK",
  "BLOT_LINT_VARIANT_MAP",
  "BLOT_MANAGED_TEST_DIRECTORY",
  "BLOT_MISPLACED_REC",
